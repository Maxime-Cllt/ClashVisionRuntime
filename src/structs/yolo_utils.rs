...
//         let blend_pixel = Rgb([
//             ((pixel[0] as u16 * pixel[3] as u16 + orig_pixel[0] as u16 * (255 - pixel[3]) as u16)
//                 / 255) as u8,
//             ((pixel[1] as u16 * pixel[3] as u16 + orig_pixel[1] as u16 * (255 - pixel[3]) as u16)
//                 / 255) as u8,
//             ((pixel[2] as u16 * pixel[3] as u16 + orig_pixel[2] as u16 * (255 - pixel[3]) as u16)
//                 / 255) as u8,
//         ]);
...
// }
//
// /// Output bounding boxes to a YOLO-format text file.
...
//             "{} {} {} {} {}\n",
//             bbox.class_id,
//             x_center / image_width as f32,
//             y_center / image_height as f32,
...
//             probability: 0.0,
//         };
//         assert_eq!(a.iou(&b), 1.0 / 7.0); //should be 1/7
//     }
// }
